module.exports = function(grunt) {
  grunt.initConfig({
    ...
    uglify: {
      ...
      dist: {
        src: 'dist/dice-roll.js',
        dest: 'dist/dice-roll.min.js'
      },
      full: {
        src: 'dist/dice-roll.full.js',
        dest: 'dist/dice-roll.full.min.js'
      }
    },
    clean: {
      bower: [
