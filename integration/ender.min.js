...
/*!
    ...
    * MIT License
    */
!function(b,c){typeof a!="undefined"&&a.exports?a.exports=c():typeof define=="function"&&typeof define.amd=="object"?define(c):this[b]=c()}("diceRoll",function(){var b=1e3,c=typeof a!="undefined"?!1:typeof ender!="undefined"?require("cookie-monster"):window.monster,d=function(a,b){this.expires=b||7,this.key="diceroll-"+a,this.cookieValue=c?c.get(this.key):!1,this.tests=[]};d.prototype.test=function(a,b){return this.tests.push({percentage:a,callback:b}),this},d.prototype.otherwise=function(a){return this.elseCallback=a,this},d.prototype.run=function(){var a=Math.floor(Math.random()*b+1),d=0,e,f,g,h,i;for(var j=0,k=this.tests.length;j<k;j++){f=this.tests[j],this.cookieValue?j.toString()==this.cookieValue&&(h=!0,f.callback(f.percentage,j)):(e=f.percentage/100*b,a>=d&&a<=d+e?(c&&c.set(this.key,j.toString(),this.expires),f.callback(f.percentage,j),h=!0):h=!1,d+=e+1);if(h)return}this.elseCallback&&(c&&c.set(this.key,j.toString(),this.expires),this.elseCallback(!1,j))};var e=function(a,b){return new d(a,b)};return e}),provide("dice-roll",a.exports),$.ender(a.exports)}()